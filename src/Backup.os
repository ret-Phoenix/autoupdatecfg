...
//   Булево
//
Функция СделатьВыгрузку(Параметры) Экспорт
	...
	ПутьВыгрузки = ОбъединитьПути(Параметры.КаталогКопий, Параметры.ИмяФайлаВыгрузки + "-" + СтрДата + Суфикс + ".dt");
...
//   Булево
//
Функция СделатьГрубуюВыгрузку(Параметры) Экспорт
	...
	Конфигуратор.ВыгрузитьИнформационнуюБазу(ОбъединитьПути(КаталогКопий, Параметры.ИмяФайлаВыгрузки + "-" + СтрДата + Суфикс + ".dt"));
...
Функция СоздатьАрхив(Параметры) Экспорт
	...
	СтрокаКоманды = Параметры.Архиватор + " " + Параметры.КлючиАрхиватора + " " 
		+ ОбъединитьПути(Параметры.КаталогКопий,Параметры.ИмяФайлаВыгрузки) + "-" + СтрДата + Суфикс + " " + ФайлБазы;
